pipeline {
    ...
    stages {
        stage('Checkout') {
            steps {
                git 'https://github.com/mohay22/task4.git' // Replace with your repository
            }
        }
        ...
        stage('SonarQube Analysis') {
            steps {
                withSonarQubeEnv('SonarQube') {
                    withCredentials([string(credentialsId: 'sqp_17210fbe55defb6a3ca7f91fc64883259c7e5352', variable: 'SONAR_LOGIN')]) {
                        script {
